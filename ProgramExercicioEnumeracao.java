...
public class ProgramExercicioEnumeracao {
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.print("Enter department's enter:" );
		...
		//QUANTOS CONTRATOS TEM ESSE TRABALHADOR
		...
		for(int i=1; i<=n; i++) {
			...
			//ASSOCIAR O CONTRATO AO TRABALHADOR - METODO addContract da Classe Worker
